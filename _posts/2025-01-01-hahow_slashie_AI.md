...
Kaggle 是一個專門為資料科學研究設計，進行資料分析和AI預測競賽的線上平臺，曾和 NASA、維基百科、德勤和微軟等知名企業合作舉辦競賽，最終由出題企業選出的最佳方案，並進行排名。在台灣，許多企業面試 AI 相關領域工作的求職者時，也會使用 Kaggle 上的競賽來出題測試求職者。


對於剛入門AI的初學者來說，獨立參加 Kaggle 平台上的比賽並不容易。因此在本課程中，講師會一步一步、穩紮穩打的帶領學員從帳號設置開始學習，並在兩項專案中取得排名前 35%，讓學員們的履歷更具說服力。